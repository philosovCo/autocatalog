    ...
    <div class="row">
        ...
        <div class="col-sm-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="<%= request.getContextPath() %>/catalog/details/<%= item.getId() %>"
                       class="card-link">Details</a>
                    <a href="<%= request.getContextPath() %>/catalog/edit/<%= item.getId() %>"
                       class="card-link">Edit</a>
                    <a href="#"
                       data-href="<%= request.getContextPath() %>/catalog/delete/<%= item.getId() %>"
